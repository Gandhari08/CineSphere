const global = {
  ...
  api: {
    key: 'de518e64241e5e94ffe9789e3dfd4de4',
  ...
  <div class="details-top">
      ...
      `<img
        ...
        <div class="details-bottom">
          <h2>Movie Info</h2>
          <ul>
            <li><span class="text-secondary">Budget:</span> $${movie.budget} million</li>
            <li><span class="text-secondary">Revenue:</span> $${movie.revenue} million </li>
...
function displayPagination() {
  ...
  //disable prev button first page.
...
//spinner when the data is fetching.
function showSpinner() {
  document.querySelector('.spinner').classList.add('show');
}
//removing spinner when the data is fetched.
